...
**Status:** Draft with Phase 0 decisions baked in — Ready for Claude Code ingestion  
**Changelog from v1.0:** §17 Open Questions resolved into §17 Phase 0 Decisions. §9.4 customer pricing restructured around free vs. One Roof+ tiers. §9.6 added (Property Manager pricing). §10 anti-disintermediation enforcement framework codified. §15 phased rollout updated for Savannah pilot and Expo native sequencing. "One Roof Pro" name adopted for the contractor console.
...
17. [Phase 0 Decisions (Resolved)](#17-phase-0-decisions-resolved)
...
The customer side is **free to use the marketplace**. No paywall on the core experience. The free tier must be enough to actually run a household through the platform; One Roof+ adds depth for power users and multi-property owners.

#### Free tier (always)

- Unlimited service requests and quotes.
- Browse the full contractor directory; book any contractor.
- On-platform messaging, scheduling, and payment.
- Reviews, ratings, dispute access.
- Standard warranty tracking on Branded jobs.
- Up to 1 property under a single household.
- Maintenance record retention: 3 years.

#### One Roof+ ($9.99/month or $79/year — pilot pricing)

- Up to 5 properties under a household.
- **Extended warranty** on Branded jobs (workmanship coverage extended from 1 year to 2 years).
- **Priority booking** in lead routing — your requests jump the response queue.
- **Recurring service discounts** — 5–10% off platform take when applied as customer rebate on contracts (HVAC quarterly, lawn weekly, pest monthly).
- Maintenance record retention: indefinite.
- "Resale packet" PDF export with one click (every contractor receipt, photo, and warranty doc bundled).
- Concierge handoff from Home Doctor recommendations (auto-quote without manual review).

#### Property Manager (separate tier — see §9.6)

For 3+ doors, customers move to the Property Manager pricing structure. One Roof+ is included in all paid Property Manager tiers.
...
### 9.6 Property Manager Pricing

| Tier | Doors | Price | Monthly Minimum | Notes |
|---|---|---|---|---|
| Free (Accidental Landlord) | 1–2 | $0 | — | Full PM features unlocked. Captures the "I inherited a duplex" persona. |
| Standard | 3–25 | $5/door/month | $25/mo | Tenant portal, work-order workflow, recurring contracts, document vault. One Roof+ included. |
| Growth | 26–100 | $4/door/month | $130/mo | All Standard + dedicated support contact, advanced reporting, multi-user team accounts. |
| Enterprise | 100+ | Custom | Negotiated | API access, white-label tenant portal options, custom SLA, custom data export. |

**Annual prepay**: 2 months free on Standard and Growth tiers (effectively ~17% discount).

**Why this structure**: AppFolio's $300/mo minimum locks out small operators; TenantCloud's free-to-paid jump is jarring. Our free tier captures inherited-property and accidental-landlord cases that otherwise stay on spreadsheets, then ramps gracefully into Standard as those landlords grow. Growth's per-door reduction rewards scaling.

### 9.7 Platform Satisfaction Guarantee (Dispute Coverage)

Branded jobs include a platform-backed satisfaction guarantee, layered by contractor tier. This is a customer-facing benefit and a primary anti-disintermediation lever (warranty does not travel off-platform).

| Coverage Level | Per-Job Cap | Annual Aggregate Per Contractor | Coverage Scope |
|---|---|---|---|
| Verified (Open) | $500 | $2,500 | Mediation only — no platform payout, contractor responsible |
| Branded — Solo | $2,500 | $10,000 | Full satisfaction guarantee |
| Branded — Pro / Master | $10,000 | $25,000 | Higher-stakes work; Master tier earns the larger backstop |

**What's covered**: workmanship that does not meet trade standards, no-shows after deposit paid, materials substantially wrong vs. quote, scope abandonment without cause.

**What's not covered**: customer-supplied materials that fail; undocumented scope changes; acts of God; pre-existing conditions disclosed and accepted by customer; anything the customer signed off on at job closeout; cosmetic preference disputes where work meets trade-standard quality.

**Warranty windows**:
- Workmanship: 1 year default; 2 years for One Roof+ subscribers on Branded jobs.
- Major system installs (HVAC, water heater, roofing, electrical panel): 1 year labor coverage + manufacturer parts coverage tracked separately.

**Funding**: 1% of platform take rate per closed Branded job is reserved into a dedicated trust account. Sustainable without external capital.

**Contractor accountability**: payouts under the guarantee count against the contractor's standing. Repeat triggers result in tier review (see §8.6 Revocation).
...
### 10.4 Enforcement Framework (codified)

This is the operating policy that turns Section 10 from a strategy into something the platform can execute. The contract language with contractors will be tightened by counsel at execution time, but the policy spine below is canonical.

#### 10.4.1 Definitions

- **Platform-sourced customer**: a customer that this contractor first transacted with through One Roof Homes. The customer remains a platform-sourced customer of this contractor for **12 months** from the date of the last completed on-platform job between them. After 12 months of complete on-platform inactivity between that pair, the relationship reverts to organic and unrestricted.
- **On-platform**: any job booked, run, invoiced, and paid through One Roof Homes.
- **Off-platform**: any work performed outside the One Roof Homes system, regardless of how it is billed.

#### 10.4.2 What is restricted (within the 12-month cooling-off window)

For platform-sourced customers, the contractor shall not:
- Solicit off-platform work from the customer.
- Knowingly accept off-platform work the customer initiates without first offering to bring it on-platform.
- Use the One Roof brand (apparel, decals, business cards, "One Roof Certified" representation, "Powered by One Roof" badges) on off-platform work for any customer.

#### 10.4.3 What is explicitly permitted

- **Customer-initiated rebooking on-platform** — encouraged, frictionless, single tap.
- **Genuine emergencies** where the customer cannot reach the platform, with same-day or next-business-day report-back ("I helped them, please log this"). The platform processes the job retroactively at standard rates and take. Repeated use of the emergency exception will be reviewed for pattern.
- **Any work for customers the contractor sourced themselves** outside the platform.
- **Any work for platform-sourced customers after the 12-month cooling-off** has elapsed.

#### 10.4.4 Enforcement Tiers

| Signal | Trigger | Response |
|---|---|---|
| **Soft** | Pattern signal: contractor's repeat-rate is significantly below the trade-cohort mean with no obvious explanation | Outreach: *"How can we help you serve repeat customers better?"* No consequence; logged for context only. |
| **Moderate** | One credible customer report of being asked off-platform, OR pattern signal + one corroborating data point | Documented conversation with contractor; written reminder of policy; flagged for monitoring. |
| **Strong** | Two or more credible customer reports, OR contractor admission, OR brand assets observed in use on off-platform work | First formal warning. Branded status placed on **probation for 90 days**. Reduced lead priority during probation. Required policy acknowledgement. |
| **Severe** | Pattern of strong signals, OR repeat behavior after warning, OR clear fraud | **Branded status revocation.** Demoted to Verified. Brand kit recalled. Platform reserves right to refund affected customers retroactively. |
| **Egregious** | Use of the One Roof brand to mislead a customer about the nature of off-platform work, OR identity fraud, OR repeat after revocation | **Full platform removal. Permanent ban.** Civil action available where damages are quantifiable. |

#### 10.4.5 Operating Principles

1. **Outreach before punishment.** Most off-platform drift is contractors not knowing how to keep customers on-platform, not malice. The first response is always to help, not punish.
2. **No surveillance.** We do not read messages, emails, or texts. Detection is pattern signals plus customer reports only. This is both an ethical commitment and a practical necessity for trust.
3. **Customer protection is the moral ground.** The reason for these rules is that warranty, dispute resolution, and the One Roof guarantee only function on-platform. Off-platform work hurts the customer if it goes wrong. We frame it that way to contractors and we mean it.
4. **Due process is built in.** Every escalation tier above Soft is documented, contractor-visible, and appealable. The contractor sees what triggered the response and how to clear it.
...
- **Single-market launch**: **Savannah, GA metro** — coordinated with the Home Doctor Savannah pilot. Coastal Georgia offers older housing stock (lots of carpentry, painting, concrete), hurricane-related repair demand, and a multi-property STR/Airbnb base on Tybee Island that exercises the property-manager surface early.
- **PWA-first** for both customer and contractor surfaces (installable home-screen, offline-tolerant for contractor).
- **Closed pilot** with a small cohort of Billy Harrell-archetype contractors before public beta.

### Phase 2 — Branded Program & One Roof Pro (Mobile) Begins (6–8 weeks)

- Branded knowledge tests per major trade category.
- Brand kit fulfillment integration (initial kit free; replacement at cost).
- Branded ranking signals in lead routing.
- Quality audit and mystery-shop tooling.
- Dispute coverage SLA for Branded jobs (per §9.7).
- **One Roof Pro Expo app development begins** — native iOS/Android contractor app (camera, GPS, push, offline-tolerant). Shares business logic with web via Turborepo packages.

### Phase 3 — Back-Office Services & One Roof Pro (Mobile) Ships (6–10 weeks)
...
- **One Roof Pro Expo app live** in iOS App Store and Google Play. Customer surface remains PWA.
- CE content live via partnerships with NARI, PHCC, NECA, ACCA, NRCA (see §17.8).

### Phase 4 — Property Management & Customer Mobile Begins (6–8 weeks)

- Multi-property portfolio dashboard.
- Tenant portal, work-order workflow.
- Recurring service contracts.
- Per-portfolio budgets and reporting.
- **Customer Expo app development begins** in parallel.

### Phase 5 — Home Doctor Deep Integration & Customer Mobile Ships (4–6 weeks)
...
- **Customer Expo app live**.

### Phase 6+ — Expansion

- Geographic expansion: Atlanta and Charleston are natural Phase 6 candidates (adjacent metros, similar housing profile, Home Doctor expansion alignment).
- Then state-by-state, weighted by license-data API availability.
...
## 17. Phase 0 Decisions (Resolved)

The following decisions were made before Phase 1 build-out begins. They supersede the v1.0 open questions.

### 17.1 Initial market: **Savannah, GA metro**

Coordinated with the Home Doctor Savannah pilot — both products launch in the same metro for a unified ground-truth feedback loop. Coastal Georgia offers older housing stock that exercises the carpentry/painting/concrete trades, hurricane-driven repair demand for resilience features, and a multi-property STR/Airbnb base on Tybee Island that lets us validate the property-manager surface early.

### 17.2 Take-rate calibration: **§9.2 numbers as proposed**

Pilot at the proposed tiers (3–5% Open, 8–10% Branded Solo, mid % + monthly subscription for Branded Pro). The "$5–$10 less per job" framing was illustrative for the contractor pitch, not literal. Calibration adjustments by trade or cohort are reserved for post-pilot data review.

### 17.3 Brand-kit economics: **Free initial kit, at-cost replacement**

Branded contractors receive an initial brand kit at no charge upon Branded eligibility. Replacement items are at platform cost. The initial kit composition:
- 3 short-sleeve shirts (sized to contractor)
- 2 long-sleeve shirts
- 1 lightweight jacket / vest (climate-appropriate)
- 2 hats
- 1 set of vehicle decals (truck/van — magnetic and vinyl options)
- 100 co-branded business cards with contractor photo
- 4 yard signs

Master tier earns a quarterly refresh allotment.

### 17.4 Dispute coverage cap: **Tiered (per §9.7)**

- Verified: $500/job, $2,500 annual aggregate (mediation only — no platform payout).
- Branded Solo: $2,500/job, $10,000 annual aggregate (full guarantee).
- Branded Pro / Master: $10,000/job, $25,000 annual aggregate.
- Funded from a 1% reserve carved out of platform take rate per closed Branded job.
- Detailed coverage scope, exclusions, and warranty windows in §9.7.

### 17.5 Customer subscription pricing: **Free tier + One Roof+ at $9.99/mo or $79/yr**

Free tier is the default and includes full marketplace access — no paywall on the core experience. One Roof+ adds depth for power users and small multi-property owners (up to 5 properties). Detailed feature split in §9.4.

### 17.6 Property Manager pricing: **Tiered per §9.6**

- Free: 1–2 doors (accidental landlord persona)
- Standard: 3–25 doors at $5/door/month, $25/mo minimum
- Growth: 26–100 doors at $4/door/month, $130/mo minimum
- Enterprise: 100+ doors, custom pricing

Annual prepay earns 2 months free on Standard and Growth.

### 17.7 Background check funding: **Contractor-funded as part of Branded application**

Standard practice and a useful seriousness filter. Estimated cost ~$30–60 per Checkr basic + MVR check, transparently disclosed at application time. Failed checks do not block re-application after applicable waiting periods.

### 17.8 CE content: **Partner with trade associations first**

Phase 1–3 content sourced via partnership with the relevant trade associations:
- **NARI** (National Association of the Remodeling Industry) — remodeling and renovation
- **PHCC** (Plumbing-Heating-Cooling Contractors) — plumbing, HVAC
- **NECA** (National Electrical Contractors Association) — electrical
- **ACCA** (Air Conditioning Contractors of America) — HVAC
- **NRCA** (National Roofing Contractors Association) — roofing
- **NAHB** (National Association of Home Builders) — general construction

In-house authoring is a Phase 4+ consideration once content gaps are visible from usage data.

### 17.9 Brand & marketing: **In-house design**

Internal design ownership for first-round brand kit, apparel, and marketing materials. External freelance/agency engagements reserved for specific overflow needs (e.g., professional product photography for the apparel line, contractor-recruitment video).

### 17.10 Mobile strategy: **PWA → Expo Native (sequenced)**

| Phase | Customer Surface | Contractor Surface |
|---|---|---|
| 1 (MVP) | PWA (installable) | PWA (installable) |
| 2 (Branded) | PWA | PWA + Expo Contractor build begins |
| 3 (Back-Office) | PWA | **Expo Contractor app live** ("One Roof Pro") |
| 4 (PM) | PWA + Expo Customer build begins | Expo Contractor |
| 5+ | Expo Customer app live | Expo Contractor |

**Rationale**: Expo wins long-term — single codebase, shared business logic with the Next.js web app via Turborepo packages, EAS Build/Submit, EAS Update for non-native fixes, mature New Architecture (Fabric/TurboModules) in 2026. The team has shipped Expo before (MealMap), so muscle memory exists.

**Contractor app first** because contractors are in the field — camera, GPS, fast photo upload, reliable push notifications, and offline tolerance materially affect their willingness to use the platform. Customers are mostly couch-and-laptop or couch-and-phone-browser; the customer PWA may live on as a permanent secondary surface even after the Expo customer app ships.

### 17.11 Contractor-console branding: **One Roof Pro**

Adopted. The contractor-side console (web and mobile) is branded **One Roof Pro**. Works on the back of a polo. Internal contractor support team also rebrands to One Roof Pro Support.

### 17.12 Anti-disintermediation enforcement: **Per §10.4**

Codified as the framework in §10.4. Headline summary:
- 12-month cooling-off window for platform-sourced customers.
- Five enforcement tiers from Soft (outreach only) through Egregious (permanent ban).
- No surveillance — pattern signals and customer reports only.
- Customer-initiated rebooking and genuine emergencies explicitly permitted.
- Due process and appeals built in at every tier above Soft.

Counsel will tighten contract language at execution; the policy spine is canonical and built into the product.

---

## 17A. Decisions Reserved for Phase 1

Decisions that depend on pilot data and are deliberately left open until then:

1. **Take-rate trade-by-trade calibration** — review after 90 days of pilot data; adjust per-trade if material variance shows.
2. **One Roof+ feature gating refinement** — observe what free-tier users hit ceilings on; adjust paid-tier feature mix accordingly.
3. **Master-tier mentorship requirement** — currently set at "≥ 1 active apprentice"; refine after we have enough apprentices to know what active means in practice.
4. **Geographic expansion sequence beyond Phase 6** — driven by Home Doctor expansion plan, license-data API availability, and pilot retention curves.
...
*End of PRD v1.1 — One Roof Homes*  
*Phase 0 decisions baked in. Ready for Phase 1 build kickoff.*  
*Next companion documents: TARA (Threat Analysis), Drizzle Schema, Phase 1 Sprint Plan, Contractor Agreement (legal review of §10.4 framework), Brand Kit Spec, Trade Scope Templates (per-trade detail).*
